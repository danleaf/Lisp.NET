...
namespace Dandan.VisualLisp.Intellisense
{
    ...
    class RefrenceTaggerProvider : IViewTaggerProvider
    {
        [Import]
        ITextSearchService TextSearchService { get; set; }

        [Import]
        ITextStructureNavigatorSelectorService TextStructureNavigatorSelector { get; set; }
        ...
        ITagger<T> IViewTaggerProvider.CreateTagger<T>(ITextView textView, ITextBuffer buffer)
        {
            ...
            return new RefrenceTagger(textView, buffer, TextSearchService, textStructureNavigator) as ITagger<T>;

        }
    }

    class RefrenceTagger : ITagger<TextMarkerTag>
    {        
        ...
        EventHandler<SnapshotSpanEventArgs> tagsChanged;

        public RefrenceTagger(ITextView view, ITextBuffer sourceBuffer, ITextSearchService textSearchService,
            ITextStructureNavigator textStructureNavigator)
        {
            this.View = view;
        ...
        event EventHandler<SnapshotSpanEventArgs> ITagger<TextMarkerTag>.TagsChanged
        {
